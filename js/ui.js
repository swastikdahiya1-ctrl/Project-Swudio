...
export function renderSidebar() {
    ...
    <div class="sb-logo-wrap" style="display:flex; align-items:center; gap:12px;">
      <img src="LOGO.png?v=2" alt="Logo" class="sb-logo" style="width: 32px; height: 32px; border-radius: 6px; padding: 0; background: transparent; border: none; object-fit: contain;">
      ${authBtnHtml}
    </div>
