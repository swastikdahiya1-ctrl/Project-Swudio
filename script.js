    ...
    <div class="canvas-wrap" id="canvas-wrap">
      ...
      <div class="canvas-surface" id="canvas-surface" tabindex="0">
        <div class="canvas-inner" id="canvas-inner">
           <canvas id="canvas-draw-layer" width="4000" height="4000" style="position:absolute; top:-2000px; left:-2000px; pointer-events:none; z-index:1;"></canvas>
    ...
    function renderElements() {
        ...
        bd.elements.filter(e => e.type !== 'stroke').forEach(el => {
            ...
            if (el.type === 'text') {
                ...
                htmlStr = `<div class="el-inner" style="width:100%;height:100%;"><img src="${el.src}" draggable="false" style="width:100%;height:100%;object-fit:fill;display:block;border-radius:2px;pointer-events:none;"></div>`;
